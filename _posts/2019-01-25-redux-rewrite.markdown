...
{% include image.html url="/assets/images/cosmicBrain.jpg" description="Each time I speak about Redux to someone." %}
...
{% include image.html url="/assets/images/dwarfFortressDifficulty.jpg" description="Replace Dwarf Fortress with Redux." %}
...
{% include image.html url="/assets/gif/whut.gif" description="Me. I’m a penguin." %}
...
{% include image.html url="/assets/gif/thatsallquestion.gif" description="" %}
...
{% include image.html url="/assets/gif/what1.gif" description="You." %}
...
{% include image.html url="/assets/gif/volcano.gif" description="My brain. Your brain. Everyone’s brain reading that." %}
...
{% include image.html url="/assets/gif/magic.gif" description="You. Me. Everyone." %}
...
{% include image.html url="/assets/gif/what2.gif" description="You." %}
...
{% include image.html url="/assets/gif/unicorn.gif" description="" %}
